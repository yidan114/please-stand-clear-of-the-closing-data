...
Yidan Kong — QMSS, Columbia.# Please Stand Clear of the Closing Data
...
Week 1 — data ingest and EDA. Brief and signature chart pending.

## Stack

R + RMarkdown for the brief and final figures.
Python + pandas + GeoPandas for data prep and spatial joins.
Panel regression with line and time fixed effects; cluster-robust
standard errors at the line level.
